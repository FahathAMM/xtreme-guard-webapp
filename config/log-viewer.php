...
return [
    ...
    */
    ...
    'hosts' => [
        ...
        'production' => [
            'name' => 'Production',
            // 'host' => 'https://jtiksa.routepro.cloud/sap/log-viewer',
            'host' => 'https://xtremeguard.org/log-viewer',

            'auth' => [      // Example of Bearer token auth
                // 'token' => env('LOG_VIEWER_PRODUCTION_TOKEN'),
                // 'username' => 'fahath',  // Set in your .env file
                // 'password' => 'Fahath@123',  // Set in your .env file
